                        ...
                        <div class="row" style="text-align:center">
                        	...
                        	<!-- <div class="col-md-4 col-sm-4 m-b0">
                                ...
                                <div class="mt-icon-box-wraper center m-b30">
                                    ...
                                    <div class="bg-cover  half-blocks-bg" style="background-image:url(<?= base_url()?>assets-front/images/services/2.jpg)"></div>
                                </div>
                                </div>
                            </div> -->
            ...
            <!-- ABOUT COMPANY START -->
            <div class="section-full " style="background-image:url(<?= base_url()?>assets-front/images/background/bg-map.png)">
                            	...
                            	<div class="col-md-5 col-sm-6">
                                    ...
                                    <div class="author-info author-info-v2 p-t20">
                                        ...
                                        <div class="author-signature">
                                            <img style="height:100px;width:200px" src="<?= base_url()?>xfile/ttd.png" alt="Signature" width="150">
                                        </div>
                    ...
                    <div class="container get-in-touch-form">
                        ...
                        <div class="row">
                            ...
                            <div class="get-in-touch-form-section">
                                <div class="get-in-touch-form-section-img"><img src="<?= base_url()?>assets-front/images/s-pic-1.png" alt=""></div>
                                <div class="get-in-touch-info arrow-animation">
                                    <div class="mt-icon-box-wraper  p-a20 left bg-white hover-shadow">
                                        <div class="icon-md m-b20 scale-in-center">
                                            <span class="icon-cell text-secondry"><img src="<?= base_url()?>assets-front/images/icon/icon-img-01.png" alt=""></span>
                                        </div>
                                        <div class="icon-content">
