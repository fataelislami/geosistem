  ...
  <div class="container">
    ...
    <div class="mt-separator-outer separator-left">
      <div class="mt-separator">
        <h2 class="text-uppercase sep-line-one "><span class="font-weight-300 text-primary">Our</span> Product</h2>
      </div>
    </div>
    </div>
        <!-- PAGINATION START -->
                       ...
                       <div class="mt-thum-bx img-center-icon  mt-img-overlay2">
                           ...
                           <div class="overlay-bx">
                               <div class="overlay-icon">
                                   <a href="<?= base_url() ?>product/instrumentation">
                                       <i class="fa fa-external-link mt-icon-box-xs "></i>
                                   </a>
                                   <a class="mfp-link" href="<?= base_url()?>xfile/product/instrumentation.jpg">
             ...
             <div class="project-classic">
                   <div class="mt-box ">
                       <div class="mt-thum-bx img-center-icon  mt-img-overlay2">
                           ...
                           <div class="overlay-bx">
                               <div class="overlay-icon">
                                   <a href="<?= base_url() ?>product/geosynthetic-clay-liners">
                                       <i class="fa fa-external-link mt-icon-box-xs "></i>
                                   </a>
                                   <a class="mfp-link" href="<?= base_url()?>xfile/product/geosynthetic.jpg">
                                       <i class="fa fa-arrows-alt mt-icon-box-xs"></i>
                                   </a>
                             </div>
                           </div>
             ...
             <div class="project-classic">
                   <div class="mt-box ">
                       <div class="mt-thum-bx  img-center-icon  mt-img-overlay2">
                           ...
                           <div class="overlay-bx">
                               <div class="overlay-icon">
                                   <a href="<?= base_url() ?>product/prefabricated-vertical-drain">
                                       <i class="fa fa-external-link mt-icon-box-xs "></i>
                                   </a>
                                   <a class="mfp-link" href="<?= base_url()?>xfile/product/pvd.jpg">
                                       <i class="fa fa-arrows-alt mt-icon-box-xs"></i>
                                   </a>
                             </div>
                           </div>
             ...
             <div class="project-classic">
                   <div class="mt-box ">
                       <div class="mt-thum-bx img-center-icon  mt-img-overlay2">
                           ...
                           <div class="overlay-bx">
                               <div class="overlay-icon">
                                   <a href="<?= base_url() ?>product/geogrid">
                                       <i class="fa fa-external-link mt-icon-box-xs "></i>
                                   </a>
                                   <a class="mfp-link" href="<?= base_url()?>xfile/product/geogrid.jpg">
                                       <i class="fa fa-arrows-alt mt-icon-box-xs"></i>
                                   </a>
                             </div>
                           </div>
             ...
             <div class="project-classic">
                   <div class="mt-box ">
                       <div class="mt-thum-bx img-center-icon  mt-img-overlay2">
                           ...
                           <div class="overlay-bx">
                               <div class="overlay-icon">
                                   <a href="<?= base_url() ?>product/geomembrane">
                                       <i class="fa fa-external-link mt-icon-box-xs "></i>
                                   </a>
                                   <a class="mfp-link" href="<?= base_url()?>xfile/product/geomembrane.jpg">
                                       <i class="fa fa-arrows-alt mt-icon-box-xs"></i>
                                   </a>
                             </div>
                           </div>
             ...
             <div class="project-classic">
                   <div class="mt-box ">
                       <div class="mt-thum-bx img-center-icon  mt-img-overlay2">
                           ...
                           <div class="overlay-bx">
                               <div class="overlay-icon">
                                   <a href="<?= base_url() ?>product/geotextile">
                                       <i class="fa fa-external-link mt-icon-box-xs "></i>
                                   </a>
                                   <a class="mfp-link" href="<?= base_url()?>xfile/product/geotextile.jpg">
                                       <i class="fa fa-arrows-alt mt-icon-box-xs"></i>
                                   </a>
                             </div>
                           </div>
