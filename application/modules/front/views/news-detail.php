    ...
    <div class="container">
        ...
        <div class="blog-post date-style-3 blog-detail text-black">
                ...
                <ul class="grid-post">
                    <li>
                        <div class="portfolio-item">
                            <img class="img-responsive" src="<?= base_url()?>assets-front/images/blog/default/thum1.jpg" alt="">
                        </div>
                    </li>
              </ul>
            </div>
            ...
            <div class="mt-post-meta ">
                <ul>
                    <li class="post-date"><strong>20 </strong> <span>June 2019</span> </li>
                    <li class="post-author"><a href="javascript:void(0);">By <span>Admin</span></a> </li>
                    <li class="post-category"><a href="javascript:void(0);"><span>Traditional</span></a> </li>
                </ul>
            </div>

            <div class="mt-post-title ">
                <h2 class="post-title"><a href="javascript:void(0);" class="font-weight-600">From complete turn key to project manager. Leave the building to the professionals.</a></h2>
            </div>
...
<p> Proin tincidunt tellus ac porta volutpat. Cras mattis congue lacus id bibendum. Mauris ut sodales libero. Maecenas feugiat sit amet enim in accumsan. Here, then, is what I wanted to tell you of my architecture. I created it with courage and idealism, but also with an awareness of the fact that what is important is life, friends, and attempting to make this unjust world a better place in which to live.</p>
                <blockquote class="bg-dark text-white author-quote">
                    <h4 class="m-b0">We let our quality work and commitment to customer satisfaction be our slogan. quality you deserve and dependability you can count on.<i class="fa fa-quote-right"></i> </h4>
                    <div class="p-t15  text-white">
                        <strong class="text-primary">Jessica Mcdade</strong>
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-4">
                        <div class="mt-box m-b30">
                            <div class="mt-media">
                                <img src="<?= base_url()?>assets-front/images/blog/large-blog.jpg" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-4">
                        <div class="mt-box m-b30">
                            <div class="mt-media">
                                <img src="<?= base_url()?>assets-front/images/blog/large-blog2.jpg" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-4">
                        <div class="mt-box m-b30">
                            <div class="mt-media">
                                <img src="<?= base_url()?>assets-front/images/blog/large-blog3.jpg" alt="">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="section-content">
            <div class="row">
                <div class="col-md-4 col-sm-6">
                    <div class="mt-box blog-post latest-blog-3 date-style-1 bg-white m-b30">
                      <div class="mt-post-media mt-img-overlay7">
                            <a href="javascript:;"><img src="<?= base_url()?>assets-front/images/blog/latest-blog/pic1.jpg" alt=""></a>
                        </div>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="mt-box blog-post latest-blog-3 date-style-1 bg-white m-b30">
                      <div class="mt-post-media mt-img-overlay7">
                            <a href="javascript:;"><img src="<?= base_url()?>assets-front/images/blog/latest-blog/pic2.jpg" alt=""></a>
                        </div>
                        <div class="mt-post-info p-a30 bg-gray">
                          <div class="post-overlay-position">
                                <div class="mt-post-meta ">
                ...
                <div class="col-md-4 col-sm-12">
                    <div class="mt-box blog-post latest-blog-3 date-style-1 bg-white m-b30">
                      <div class="mt-post-media mt-img-overlay7">
                            <a href="javascript:;"><img src="<?= base_url()?>assets-front/images/blog/latest-blog/pic3.jpg" alt=""></a>
                        </div>
                        <div class="mt-post-info p-a30 bg-gray">
                          <div class="post-overlay-position">
                                <div class="mt-post-meta ">
            ...
            <div class="comments-area" id="comments">
                ...
                <div class="p-tb30">
                          ...
                          <!-- COMMENT BLOCK -->
                            <div class="comment-body">
                                <div class="comment-meta">
                                    <a href="javascript:void(0);">20 June 2019 at 8:15 am</a>
                                </div>
                                <div class="comment-author vcard">
                                    <img  class="avatar photo" src="<?= base_url()?>assets-front/images/testimonials/pic1.jpg" alt="">
                        ...
                        <li class="comment">
                          <!-- COMMENT BLOCK -->
                            <div class="comment-body">
                                ...
                                <div class="comment-author vcard">
                                    <img  class="avatar photo" src="<?= base_url()?>assets-front/images/testimonials/pic4.jpg" alt="">
                            ...
                            <ol class="children">
                                <li class="comment odd parent">
                                    ...
                                    <div class="comment-body">
                                        ...
                                        <div class="comment-author vcard">
                                            <img  class="avatar photo" src="<?= base_url()?>assets-front/images/testimonials/pic3.jpg" alt="">
                                    ...
                                    <ol class="children">
                                        <li class="comment odd parent">
                                            <div class="comment-body">
                                                ...
                                                <div class="comment-author vcard">
                                                    <img  class="avatar photo" src="<?= base_url()?>assets-front/images/testimonials/pic2.jpg" alt="">
                    ...
                    <div class="comment-respond m-t30" id="respond">
                        ...
                        <form class="comment-form bdr-1 bdr-solid bdr-gray p-a20" id="commentform" method="post" >
                            ...
                            <p class="form-submit">
                                <button class="site-button button-sm radius-no text-uppercase font-weight-600" type="button">Submit</button>
                            </p>
